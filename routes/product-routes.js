...
expressRouter.route(`/`).get(productControllers.getAllProducts).post(authController.protect,authController.restrictTo('admin'),productControllers.uploadProductImages,productControllers.resizeProductPhoto,productControllers.createProduct);
